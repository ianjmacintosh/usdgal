...
import { getByPlaceholderText, getByText, render, screen, waitFor } from "@testing-library/react";
import App from "./App";
...
describe("<App />", () => {
  ...
  const selectItemFromCombobox = async (selectElement: Element, option: string) => {
